...
<body data-new-gr-c-s-check-loaded="14.991.0" data-gr-ext-installed="">
	...
	<img src="https://www.iitr.ac.in/Main/assets/images/top7.jpg" id="iitr" width=100% height=60%>
	
	
    <header class="header text-center">	    
	    
		<h1 class="blog-name pt-lg-4 mb-0"><a href="index.php"><?php echo $_SESSION["username"]?> </a></h1>
	    ...
	    <nav class="navbar navbar-expand-lg navbar-dark">
			...
			<div id="navigation" class="collapse navbar-collapse flex-column">
				<div class="profile-section pt-3 pt-lg-0">
					...
					<div class="bio mb-3"> < user bio ></user><br><a href="">edit profile</a></div><!--//bio-->
				...
				<ul class="navbar-nav flex-column text-left">
					<li class="nav-item"
					    <a class="nav-link"><svg class="svg-inline--fa fa-bookmark fa-w-12 fa-fw mr-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bookmark" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg=""><path fill="currentColor" d="M0 512V48C0 21.49 21.49 0 48 0h288c26.51 0 48 21.49 48 48v464L192 400 0 512z"></path></svg><!-- <i class="fas fa-bookmark fa-fw mr-2"></i> -->Badge 1</a>
					</li>
					<li class="nav-item"
					    <a class="nav-link"><svg class="svg-inline--fa fa-bookmark fa-w-12 fa-fw mr-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bookmark" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg=""><path fill="currentColor" d="M0 512V48C0 21.49 21.49 0 48 0h288c26.51 0 48 21.49 48 48v464L192 400 0 512z"></path></svg><!-- <i class="fas fa-bookmark fa-fw mr-2"></i> -->Badge 2</a>
					</li>
					<li class="nav-item"
					    <a class="nav-link"><svg class="svg-inline--fa fa-bookmark fa-w-12 fa-fw mr-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bookmark" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg=""><path fill="currentColor" d="M0 512V48C0 21.49 21.49 0 48 0h288c26.51 0 48 21.49 48 48v464L192 400 0 512z"></path></svg><!-- <i class="fas fa-bookmark fa-fw mr-2"></i> -->Badge 3</a>
					</li>
				</ul>
        ...
        '<div class="item mb-5">
                  <div class="media">
					<div class="media-body">
						    <h3 class="title mb-1"><a">'.$row["title"].'</a></h3>
						    <div class="meta mb-1"><span class="date">'.$row["timestamp"].'</span><span class="time">'."Asked By: ".$row["askedby"].'</span><span class="comment"><a href="#">'.$row["upvotes"]." Upvotes".'</a></span></div>
						    <div class="intro">'.$row["description"].'</div>
							<form action="question.php", method = "post">
							<button type="submit" class="more-link"  name="submit">Read more</button>
...
?>
    ...
    <div id="config-panel" class="config-panel d-none d-lg-block">
        <div class="panel-inner">
            <a id="config-trigger" class="config-trigger config-panel-hide text-center" href="#"><svg class="svg-inline--fa fa-cog fa-w-16 fa-spin mx-auto" data-fa-transform="down-6" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cog" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" style="transform-origin: 0.5em 0.875em;"><g transform="translate(256 256)"><g transform="translate(0, 192)  scale(1, 1)  rotate(0 0 0)"><path fill="currentColor" d="M487.4 315.7l-42.6-24.6c4.3-23.2 4.3-47 0-70.2l42.6-24.6c4.9-2.8 7.1-8.6 5.5-14-11.1-35.6-30-67.8-54.7-94.6-3.8-4.1-10-5.1-14.8-2.3L380.8 110c-17.9-15.4-38.5-27.3-60.8-35.1V25.8c0-5.6-3.9-10.5-9.4-11.7-36.7-8.2-74.3-7.8-109.2 0-5.5 1.2-9.4 6.1-9.4 11.7V75c-22.2 7.9-42.8 19.8-60.8 35.1L88.7 85.5c-4.9-2.8-11-1.9-14.8 2.3-24.7 26.7-43.6 58.9-54.7 94.6-1.7 5.4.6 11.2 5.5 14L67.3 221c-4.3 23.2-4.3 47 0 70.2l-42.6 24.6c-4.9 2.8-7.1 8.6-5.5 14 11.1 35.6 30 67.8 54.7 94.6 3.8 4.1 10 5.1 14.8 2.3l42.6-24.6c17.9 15.4 38.5 27.3 60.8 35.1v49.2c0 5.6 3.9 10.5 9.4 11.7 36.7 8.2 74.3 7.8 109.2 0 5.5-1.2 9.4-6.1 9.4-11.7v-49.2c22.2-7.9 42.8-19.8 60.8-35.1l42.6 24.6c4.9 2.8 11 1.9 14.8-2.3 24.7-26.7 43.6-58.9 54.7-94.6 1.5-5.5-.7-11.3-5.6-14.1zM256 336c-44.1 0-80-35.9-80-80s35.9-80 80-80 80 35.9 80 80-35.9 80-80 80z" transform="translate(-256 -256)"></path></g></g></svg><!-- <i class="fas fa-cog fa-spin mx-auto" data-fa-transform="down-6"></i> --></a>
